...
// Using the dot notation, assign a color property to the favCar
// object and give it a string value with the color of your choice.
// Using the dot notation, assign a covertible property to the 
// favCar object and give it a boolean value of your choice.
// Use the console to log the entire favCar object.

var clothes =[];
clothes.push("shirt");
clothes.push("banen");
clothes.push("gallaband");
clothes.push("huddie");
clothes.push("coat");
...
// please note array literal == [], and object literal == {};
